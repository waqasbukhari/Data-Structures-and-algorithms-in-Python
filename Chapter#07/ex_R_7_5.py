...
##        self._tail._next = new_node
    ...
    def rotate(self):
        ...
        pass
def ele_count(node, b = None):
    if node is b: # meaning now we have circularly reached to the initial point
        return 0
    
    if b is None:
        b = node        
    
    return 1 + ele_count(node._next, b)
...
if __name__ == '__main__':
    ...
    node = D._tail._next._next._next._next #()
    print(ele_count(node))
